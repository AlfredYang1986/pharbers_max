...
import com.pharbers.aqll.old.calc.alcalc.alfinaldataprocess.alInertDatabase
import com.pharbers.aqll.old.calc.alcalc.aljobs.alJob.{common_jobs, worker_core_calc_jobs}
...
import com.pharbers.aqll.old.calc.alcalc.almodel.{IntegratedData, westMedicineIncome}
...
import com.pharbers.aqll.old.calc.util.{GetProperties, MD5}
