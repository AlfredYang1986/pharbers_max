package com.pharbers.aqll.old.calc.alcalc.alprecess.alsplitstrategy

import com.pharbers.aqll.old.calc.alcalc.aldata.alPortion
...
class alReadExcelSplitStrategy(val c : Map[String, Any]) extends alSplitStrategy {
    ...
    override val strategy : List[Any] => List[alPortion] = { lst =>
        import com.pharbers.aqll.old.calc.alcalc.alprecess.alsplitstrategy.alSplitStrategy.read_excel_split
...
class alCoreSplitStrategy(val c : Map[String, Any]) extends alSplitStrategy {
    override val constraints: Map[String, Any] = c
    override val strategy : List[Any] => List[alPortion] = { lst =>
        import com.pharbers.aqll.old.calc.alcalc.alprecess.alsplitstrategy.alSplitStrategy.core_split
...
class alHashSplitStrategy(val c : Map[String, Any]) extends  alSplitStrategy {
    override val constraints: Map[String, Any] = c
    override val strategy : List[Any] => List[alPortion] = { lst =>
        import com.pharbers.aqll.old.calc.alcalc.alprecess.alsplitstrategy.alSplitStrategy.hash_split
