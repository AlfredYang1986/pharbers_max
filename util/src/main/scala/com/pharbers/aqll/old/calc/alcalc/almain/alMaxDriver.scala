...
import com.pharbers.aqll.old.calc.alcalc.alcmd.pkgcmd.{pkgCmd, unPkgCmd}
import com.pharbers.aqll.old.calc.alcalc.alcmd.scpcmd.scpCmd
import com.pharbers.aqll.old.calc.alcalc.aldata.alStorage
import com.pharbers.aqll.old.calc.alcalc.alemchat.sendMessage
import com.pharbers.aqll.old.calc.alcalc.alfinaldataprocess.alRestoreColl
import com.pharbers.aqll.old.calc.alcalc.alfinaldataprocess.alWeightSum._
import com.pharbers.aqll.old.calc.alcalc.aljobs.{alJob, alPkgJob}
import com.pharbers.aqll.old.calc.alcalc.aljobs.alJob._
import com.pharbers.aqll.old.calc.alcalc.aljobs.aljobtrigger.alJobTrigger.{calc_final_result, check_excel_jobs, concert_groupjust_result, finish_max_group_job, finish_max_job, _}
import com.pharbers.aqll.old.calc.alcalc.almaxdefines.{alCalcParmary, alMaxProperty, endDate, startDate}
import com.pharbers.aqll.old.calc.alcalc.alstages.alStage
import com.pharbers.aqll.old.calc.alcalc.alprecess.alprecessdefines.alPrecessDefines._
import com.pharbers.aqll.old.calc.alcalc.almodel.IntegratedData
import com.pharbers.aqll.old.calc.alcalc.mail.{Mail, MailAgent, MailToEmail}
import com.pharbers.aqll.old.calc.util.{GetProperties, StringOption}
...
import com.pharbers.aqll.old.calc.alcalc.alfinaldataprocess.alSampleCheck
import com.pharbers.aqll.old.calc.alcalc.allog.alLoggerMsgTrait
import com.pharbers.aqll.old.calc.alcalc.alprecess.alsplitstrategy.server_info
