...
//import com.pharbers.aqll.alMSA.alCalcMaster.alMasterTrait.alCameoFilterPanel.filter_panel_end
...
//import com.pharbers.aqll.alMSA.alCalcMaster.alMasterTrait.alCameoSplitExcel.split_panel_end
...
//        val f = a ? filter_panel_job(path, cp)
//        val r = Await.result(f, 2 minute).asInstanceOf[filter_panel_end].result
//        r must_== true
//    }
//
//    def e3 = {
...
//        val r = Await.result(f, 2 minute).asInstanceOf[split_panel_end]
//
//        r.result must_== true
//    }
//
