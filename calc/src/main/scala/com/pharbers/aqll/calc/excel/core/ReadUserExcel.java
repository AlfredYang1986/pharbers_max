...
import com.pharbers.aqll.calc.excel.exception.SAXEx;
import com.pharbers.aqll.calc.excel.exception.NULLEx;

public class ReadUserExcel<T> extends DefaultHandler{
	private ReadUserExcel hander;
	...
	public ReadUserExcel(String fileName){
	 ...
	 * @throws Exception 
	 */
	public <T> List<T> readExcel(ReadUserExcel hander, Class<T> clazz, int sheetNo, boolean hasTitle, boolean hasTop, String[] fieldNames, String[] title) throws Exception{
		this.hander = hander;
		this.clazz = clazz;
	...
	@Override
	public void endElement(String uri, String localName, String name) throws SAXEx {
...
//								}
				...
				if (target != null){
					throw new SAXEx(list, 0, 0, "is split");
				}
				rowlist.clear();
				//curRow++;
				curCol = 0;
	...
	public void startElement(String uri, String localName, String name, Attributes attributes) throws SAXException {
		...
		if(r != null){
	        ...
	        curRow = Integer.parseInt(r.substring(firstDigit))-1;
		}
		// 置空
		lastContents = "";
	}
...
//	}
	...
	public void processByRow(int optSheetIndex) throws Exception {
		...
		if(list.size() == 0) {
			...
			throw new NULLEx(fileName.substring(fileName.lastIndexOf("\\")+1));
		}
	}
