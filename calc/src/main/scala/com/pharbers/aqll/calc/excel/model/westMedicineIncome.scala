...
class westMedicineIncome(
	...
	override def toString: String = {
			...
			"yearDiagnosisNum = " + yearDiagnosisNum + 31.toChar +
			"clinicNum = " + clinicNum + 31.toChar +
			"medicineNum = " + medicineNum + 31.toChar +
			"surgeryNum = " + surgeryNum + 31.toChar +
			"hospitalizedNum = " + hospitalizedNum + 31.toChar +
			"hospitalizedOpsNum = " + hospitalizedOpsNum + 31.toChar +
