...
//        println("53 : " + StringOption.takeStringSpace(x(52)))
        ...
        new westMedicineIncome(
            ...
            StringOption.takeStringSpace(Some(x(2).split("=")(1)).getOrElse("0.0")).toDouble,
            StringOption.takeStringSpace(Some(x(3).split("=")(1)).getOrElse("0.0")).toDouble,
            ...
            StringOption.takeStringSpace(Some(x(13).split("=")(1)).getOrElse("0")).toLong,
            ...
            StringOption.takeStringSpace(Some(x(26).split("=")(1)).getOrElse("0.0")).toDouble,
            StringOption.takeStringSpace(Some(x(27).split("=")(1)).getOrElse("0")).toLong,
            StringOption.takeStringSpace(Some(x(28).split("=")(1)).getOrElse("0")).toLong,
            StringOption.takeStringSpace(Some(x(29).split("=")(1)).getOrElse("0")).toLong,
            StringOption.takeStringSpace(Some(x(30).split("=")(1)).getOrElse("0")).toLong,
            StringOption.takeStringSpace(Some(x(31).split("=")(1)).getOrElse("0")).toLong,
            StringOption.takeStringSpace(Some(x(32).split("=")(1)).getOrElse("0")).toLong,
            StringOption.takeStringSpace(Some(x(33).split("=")(1)).getOrElse("0")).toLong,
            StringOption.takeStringSpace(Some(x(34).split("=")(1)).getOrElse("0")).toLong,
            StringOption.takeStringSpace(Some(x(35).split("=")(1)).getOrElse("0")).toLong,
            StringOption.takeStringSpace(Some(x(36).split("=")(1)).getOrElse("0")).toLong,
            StringOption.takeStringSpace(Some(x(37).split("=")(1)).getOrElse("0")).toLong,
            StringOption.takeStringSpace(Some(x(38).split("=")(1)).getOrElse("0")).toLong,
            StringOption.takeStringSpace(Some(x(39).split("=")(1)).getOrElse("0.0")).toDouble,
            StringOption.takeStringSpace(Some(x(40).split("=")(1)).getOrElse("0.0")).toDouble,
            StringOption.takeStringSpace(Some(x(41).split("=")(1)).getOrElse("0.0")).toDouble,
            StringOption.takeStringSpace(Some(x(42).split("=")(1)).getOrElse("0.0")).toDouble,
            StringOption.takeStringSpace(Some(x(43).split("=")(1)).getOrElse("0.0")).toDouble,
            StringOption.takeStringSpace(Some(x(44).split("=")(1)).getOrElse("0.0")).toDouble,
            StringOption.takeStringSpace(Some(x(45).split("=")(1)).getOrElse("0.0")).toDouble,
            StringOption.takeStringSpace(Some(x(46).split("=")(1)).getOrElse("0.0")).toDouble,
            StringOption.takeStringSpace(Some(x(47).split("=")(1)).getOrElse("0.0")).toDouble,
            StringOption.takeStringSpace(Some(x(48).split("=")(1)).getOrElse("0.0")).toDouble,
            StringOption.takeStringSpace(Some(x(49).split("=")(1)).getOrElse("0.0")).toDouble,
            StringOption.takeStringSpace(Some(x(50).split("=")(1)).getOrElse("0.0")).toDouble,
            StringOption.takeStringSpace(Some(x(51).split("=")(1)).getOrElse("0.0")).toDouble,
            StringOption.takeStringSpace(Some(x(52).split("=")(1)).getOrElse("0.0")).toDouble
        )
    }
}
