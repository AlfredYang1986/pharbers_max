...
(function ($) {
    ...
    var load_cpa_tab = function (cpa_lst) {
...
//                multiple: true,
    ...
    var load_gycx_tab = function (gycx_lst) {
        layui.use('upload', function () {
            var upload = layui.upload;
...
//                multiple: true,
    ...
    layui.use('element', function () {
        ...
        element.on('tab(step)', function (data) {
            if (data.index === 0) {
                current_li = 0;
                load_cpa_tab('#cpa_lst')
            } else if (data.index === 1) {
                current_li = 1;
                load_gycx_tab('#gycx_lst')
    ...
    function changeClick(opera, btn, preBtn, postBtn, cssClass) {
        $(opera).click(function () {
            change_tab(btn, preBtn, postBtn, cssClass)
        })
    }

    changeClick('#previous_btn', 'pre', '#next_btn', '#previous_btn', 'layui-btn-disabled');
    changeClick('#next_btn', 'next', '#next_btn', '#previous_btn', 'layui-btn-disabled')
    // $("#previous_btn").click(function () {
    //     change_tab('pre', '#next_btn', '#previous_btn','layui-btn-disabled')
    // });
    // $("#next_btn").click(function () {
    //     change_tab('next', '#next_btn', '#previous_btn','layui-btn-disabled')
    // });
